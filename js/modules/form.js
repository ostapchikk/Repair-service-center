...
function formScript() {
   let phoneInput = document.querySelector(".write__form-phone");
   let btn = document.querySelector(".form__btn");
   let timeInput = document.querySelector(".write__form-time");
   let dayInput = document.querySelector(".write__form-day");
   ...
   function phoneInputHandler() {
     if (phoneMask.masked.isComplete && timeInput.value !== "" && dayInput.value !== "") {
